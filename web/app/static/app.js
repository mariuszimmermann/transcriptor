...
function registerAdmin () {
    ...
    var address1 = $('#registration_address').val();
    var address2 = $('#registration_plz').val();
    var address3 = $('#registration_Country').val();
    var address = address1+address2+address3

    var userPool = new CognitoUserPool(poolData);
    var attributeList = [];
    var privateEmailProvider = ["web.de", "gmail.com", "gmx.de", "t-online.de"]; //If the email adress is public, don't handle it as e.g. "web" tenant
...
// Function for setting Welcome-page
function setWelcome () {
    var userPool = new CognitoUserPool(poolData);
    var cognitoUser = userPool.getCurrentUser();
...
// Function to forward the user to his dashboard
...
// Check, weather the current user is the admin
...
// Check, weather the current user is a tenant-admin
...
// Check, weather the current user is on the rigth dashboard
function userCheck() {
    var userPool = new CognitoUserPool(poolData);
    var cognitoUser = userPool.getCurrentUser();
...
// Redirection to the right tenant
...
// Redirection to the right user within a tenant
...
// Checking the access-token of the user
function dashboard () {
    var userPool = new CognitoUserPool(poolData);
    var cognitoUser = userPool.getCurrentUser();
